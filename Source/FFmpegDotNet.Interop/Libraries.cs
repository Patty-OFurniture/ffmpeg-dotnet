 ...
 namespace FFmpegDotNet.Interop
 {
     ...
     public static class Libraries
     {
         ...
         /// </summary>
         public const string AVCodec = "avcodec-62.dll"; 
         ...
         /// </summary>
         public const string AVFormat = "avformat-62.dll"; 
         ...
         /// </summary>
         public const string AVUtil = "avutil-60.dll";
         ...
         /// </summary>
         public const string SwScale = "swscale-9.dll";
